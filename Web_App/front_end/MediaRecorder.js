...
function onBtnRecordClicked (){
	if (localStream == null) {
		...
		document.getElementById("rec_div").style.pointerEvents = "none";
		document.getElementById("rec_div").style.opacity = "0.4";
		pauseResBtn.disabled = false;
		stopBtn.disabled = false;
		document.getElementById("stop_div").style.pointerEvents = "auto";
		document.getElementById("stop_div").style.opacity = "1";
...
function onBtnStopClicked(){
	...
	document.getElementById("rec_div").style.pointerEvents = "auto";
	document.getElementById("rec_div").style.opacity = "1";
	pauseResBtn.disabled = true;
	stopBtn.disabled = true;
	document.getElementById("stop_div").style.pointerEvents = "none";
	document.getElementById("stop_div").style.opacity = "0.4";
}
